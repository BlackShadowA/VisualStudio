...
model_name = 'catboost_hyperopt_featImp_QuantilePerf_without_categorizer_feats'


def prediction_generator(config_dict):
    ...
    for _, experiment in config_dict.items():
        ...
        @transform(
            ...
            predictions=Input(f"{experiment['output_location']}/inference/{exp_manager.EXPERIMENT_NAME}_{model_name}_predictions")
        )
...
TRAIN_TRANSFORMS = prediction_generator(exp_manager.config_experiment)